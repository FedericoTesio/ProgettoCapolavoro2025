...
namespace Capolavoro2025
{
    ...
    public partial class FormMagazzino : Form
    {
        ...
        private void FormMagazzino_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (allForms.Count <= 1)
            {
                Application.Exit();
        ...
        private void FormMagazzino_FormClosed(object sender, FormClosedEventArgs e)
        {
            allForms.Remove((Form)sender);
        }

        private void FormMagazzino_Load(object sender, EventArgs e)
        {
